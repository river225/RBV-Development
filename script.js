...
function showSection(name) {
  ...
  if (taxCalc) {
    const hiddenSections = ['Home', 'BlockSpin Map', 'Crew Logos', 'Crate Game', '💰 Richest Players'];
  ...
  if (searchContainer) {
    const hiddenSearchSections = ['Home', 'BlockSpin Map', 'Crew Logos', 'Crate Game', '💰 Richest Players'];
