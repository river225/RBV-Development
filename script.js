...
function showSection(name) {
  ...
  if (taxCalc) {
    const hiddenSections = ['Home', 'Crew Logos', 'Trade Checker', 'Crate Game', '💰 Richest Players'];
  ...
  if (searchContainer) {
    const hiddenSearchSections = ['Home', 'Trade Checker', 'Crew Logos', 'Crate Game', '💰 Richest Players'];
